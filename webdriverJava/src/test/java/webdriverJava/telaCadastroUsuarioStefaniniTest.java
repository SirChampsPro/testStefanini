...
public class telaCadastroUsuarioStefaniniTest {
	...
	public void validarUsuarioExcluido(String name, String xpath) {
		boolean excluir;
		
		try {
			validarExistenciaElementoPeloXpath(name, xpath);
			excluir = true;
		} catch (Exception e) {
			excluir = false;
		}
	...
	public void tela11_excluirUsuario() {
		...
		validarUsuarioExcluido("Wellington Araujo", "/html/body/div/div/div/div[2]/table/tr/td[2]");
